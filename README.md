A real-time traffic control system implemented on an STM32F4 microcontroller. Built using C and FreeRTOS, this project utilizes hardware level multitasking to model a one way traffic flow. 
